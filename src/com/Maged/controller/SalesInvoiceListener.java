 ...
 */
package com.Maged.controller;

import com.Maged.model.InvoiceHeader;
import com.Maged.model.InvoiceHeaderTableModel;
import com.Maged.model.InvoiceLine;
import com.Maged.model.InvoiceLinesTableModel;
import com.Maged.view.InvoiceFrame;
import com.Maged.view.InvoiceHeaderDialog;
import com.Maged.view.InvoiceLineDialog;
...
public class SalesInvoiceListener implements ActionListener, ListSelectionListener  {
    ...
    private void loadFile() {
        JOptionPane.showMessageDialog(frame, "Select header file!", "Attention Plz", JOptionPane.WARNING_MESSAGE);
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(frame, "Select lines file!", "Attention Plz", JOptionPane.WARNING_MESSAGE);
